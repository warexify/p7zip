...
struct CLead
{
  ...
  unsigned char Major PACKED ;  /* not supported  ver1, only support 2,3 and lator */
  unsigned char Minor PACKED ;
  short Type PACKED ;
  short ArchNum PACKED ;
  char Name[66] PACKED ;
  short OSNum PACKED ;
  short SignatureType PACKED ;
  char Reserved[16] PACKED ;  /* pad to 96 bytes -- 8 byte aligned */
